...
std::ostream& operator<<(std::ostream& s,
  ...
  ros::message_operations::Printer< ::livox_ros_driver::CustomPoint_<ContainerAllocator> >::stream(
      s, "", v);
  return s;
}
...
bool operator==(const ::livox_ros_driver::CustomPoint_<ContainerAllocator1>& lhs,
  ...
  return lhs.offset_time == rhs.offset_time && lhs.x == rhs.x && lhs.y == rhs.y && lhs.z == rhs.z &&
         lhs.reflectivity == rhs.reflectivity && lhs.tag == rhs.tag && lhs.line == rhs.line;
}
