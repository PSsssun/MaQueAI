...
std::ostream& operator<<(std::ostream& s,
  ...
  ros::message_operations::Printer<::livox_ros_driver::CustomMsg_<ContainerAllocator>>::stream(
      s, "", v);
  return s;
}
...
bool operator==(const ::livox_ros_driver::CustomMsg_<ContainerAllocator1>& lhs,
  ...
  return lhs.header == rhs.header && lhs.timebase == rhs.timebase &&
         lhs.point_num == rhs.point_num && lhs.lidar_id == rhs.lidar_id && lhs.rsvd == rhs.rsvd &&
